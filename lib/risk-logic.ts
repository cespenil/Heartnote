// Risk scoring rules — used in system prompt and for post-processing validation
// Claude assigns risk; this module provides the rule definitions and red flag templates
...
export const RISK_RULES: RiskRule[] = [
  // ── EMERGENT / HIGH ────────────────────────────────────────────────────────
  {
    ...
    clinical_concern:
      "Concurrent chest pain and dyspnea in a postpartum patient is a red-flag combination for peripartum cardiomyopathy or pulmonary embolism. Requires immediate evaluation.",
    urgency: "emergent",
    severity: "emergent",
  },
  {
    ...
    clinical_concern:
      "The combination of severe headache and visual disturbances is a hallmark presentation of postpartum preeclampsia or hypertensive emergency. Blood pressure evaluation is urgent.",
    urgency: "emergent",
    severity: "emergent",
  },
  {
    ...
    clinical_concern:
      "Unilateral calf swelling, warmth, or tenderness in the postpartum period is highly suspicious for deep vein thrombosis. DVT can progress to pulmonary embolism if untreated.",
    urgency: "urgent",
    severity: "urgent",
  },
  {
    ...
    clinical_concern:
      "Hemoptysis combined with dyspnea in a postpartum patient is a critical warning sign for pulmonary embolism. Emergent evaluation is required.",
    urgency: "emergent",
    severity: "emergent",
  },
  {
    ...
    clinical_concern:
      "Syncope in the postpartum period may indicate hemodynamic compromise, arrhythmia, or hemorrhage. Requires urgent cardiac and hemodynamic evaluation.",
    urgency: "emergent",
    severity: "emergent",
  },
  {
    ...
    clinical_concern:
      "Inability to lie flat and nocturnal dyspnea are classic signs of left-sided heart failure, consistent with peripartum cardiomyopathy.",
    urgency: "urgent",
    severity: "urgent",
  },
  ...
  // ── URGENT / MODERATE ──────────────────────────────────────────────────────
  {
    ...
    clinical_concern:
      "Bilateral pitting edema beyond what is expected in early postpartum recovery may indicate fluid overload, cardiac dysfunction, or hypertensive disease.",
    urgency: "urgent",
    severity: "urgent",
  },
  {
    ...
    clinical_concern:
      "Persistent palpitations or tachycardia in the postpartum period warrants cardiac evaluation to rule out arrhythmia or thyroid dysfunction.",
    urgency: "urgent",
    severity: "warning",
  },
  {
    ...
    clinical_concern:
      "New severe headache in the postpartum period requires blood pressure measurement to rule out postpartum preeclampsia, even without visual symptoms.",
    urgency: "urgent",
    severity: "warning",
  },
  {
    ...
    clinical_concern:
      "Facial and periorbital edema in the postpartum period is a clinical marker associated with preeclampsia and fluid retention disorders.",
    urgency: "urgent",
    severity: "warning",
  },
  {
    ...
    clinical_concern:
      "New-onset dyspnea on exertion postpartum exceeding normal deconditioning warrants evaluation for cardiac or pulmonary pathology.",
    urgency: "urgent",
    severity: "warning",
  },
  ...
  // ── ROUTINE / LOW ──────────────────────────────────────────────────────────
  {
    ...
    red_flag_label: "",
    clinical_concern:
      "Fatigue is common postpartum; no cardiovascular red flags identified. Monitor for escalating symptoms.",
    urgency: "routine",
    severity: "warning",
  },
  {
    ...
    red_flag_label: "",
    clinical_concern:
      "Mild bilateral ankle edema can be a normal postpartum finding. Document and reassess if worsening or accompanied by other symptoms.",
    urgency: "routine",
    severity: "warning",
  },
];

// The exact risk-level definitions injected into the system prompt
...
export function getRulesForRegion(region: string): RiskRule[] {
  return RISK_RULES.filter((r) => r.triggers.some((t) => t.toLowerCase().includes(region.toLowerCase())));
}
